...
begin = time.time()
# alphaTrimming("Image_(2).jpg", 1, 4)
# alphaTrimming("Image_(2).jpg", 1, 8)
# alphaTrimming("Image_(2).jpg", 2, 4)
# alphaTrimming("Image_(2).jpg", 2, 8)
# alphaTrimming("Image_(2).jpg", 3, 4)
# alphaTrimming("Image_(2).jpg", 3, 8)
# medianTimes("Image_(2).jpg", 1, 1)
# medianTimes("Image_(2).jpg", 2, 1)
# medianTimes("Image_(2).jpg", 2, 3)
# medianTimes("Image_(2).jpg", 2, 5)
# medianTimes("Image_(2).jpg", 3, 1)
# medianTimes("Image_(2).jpg", 3, 3)
# medianTimes("Image_(2).jpg", 3, 5)
# medianWeightTimes("Image_(2).jpg", 2, 1)
# medianWeightTimes("Image_(2).jpg", 2, 3)
# medianWeightTimes("Image_(2).jpg", 2, 5)
# medianWeightTimes("Image_(2).jpg", 3, 1)
# medianWeightTimes("Image_(2).jpg", 3, 3)
# medianWeightTimes("Image_(2).jpg", 3, 5)
end = time.time()
